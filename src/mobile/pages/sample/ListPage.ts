...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class ListPage extends Page {
		...
		public create(): void {
			...
			this.commandTemplate = ListPage_commandTemplate_1_8Creator(this);
	...
	function ListPage_commandTemplate_1_8Creator(__creator) {
		return class ListPage_commandTemplate_1_8 extends AtomControl {
