...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class ListPage extends Page {
		...
		public create(): void {
			...
			this.commandTemplate = ListPage_commandTemplate_1_5Creator(this);
	...
	function ListPage_commandTemplate_1_5Creator(__creator) {
		return class ListPage_commandTemplate_1_5 extends AtomControl {
